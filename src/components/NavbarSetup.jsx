      ...
      {isLoggedIn? (
          ...
          <nav className="relative px-4 py-4 flex justify-between items-center bg-gray-50">
            ...
            <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
              <li>
                <Link
                  to="/"
                  className="text-sm text-gray-500 hover:text-gray-700 hover:font-bold"
                >
                  Home
                </Link>
              </li>
              ...
              <li>
                <Link
                  to="/products"
                  className="text-sm flex text-gray-500 hover:text-gray-700 hover:font-bold"
                  href="#"
                >
                  Shop
                </Link>
            ...
            <button
              onClick={handleOpen}
              className="hidden lg:inline-block mr-10 lg:flex lg:ml-auto lg:mr-3 py-1 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
            >
              <FaShoppingBag className="hover:animate-pulse" size={"25px"} />
              <Badge
                className=""
            ...
            <button
              ...
              className="hidden mr-4 lg:inline-block py-0 px-0 bg-gray-50 hover:bg-gray-200 text-sm text-gray-900 font-bold rounded-full transition duration-200"
            >
              <FaUserCircle size={"25px"} />
            </button>
            {isDropdownOpen && (
              <div
                className="absolute right-0 mt-2 w-48 top-14 bg-white shadow-lg border rounded-md z-50" // Absolute positioning
              >
                {/* Dropdown Items */}
        ...
        <>
          ...
          <nav className="relative px-4 py-4 flex justify-between items-center bg-gray-50">
            ...
            <Link
              className="hidden lg:inline-block py-2 px-6 bg-gray-300 hover:bg-gray-600 text-sm text-white font-bold rounded-xl transition duration-200"
              to="/"
            >
              Sign up
            </Link>
